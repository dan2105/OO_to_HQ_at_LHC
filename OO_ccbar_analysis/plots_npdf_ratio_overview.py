...
MASS_CUTS = [10, 20, 30]  # GeV

def build_ratio_overview_variables(mass_cuts):
    variables = []
    for cut in mass_cuts:
        variables.extend([
            (f"h_ptcc{cut}_aftercuts", f"ptcc_mcc{cut}", "p_{T}(t#bar{t}) [GeV]", (10, 30), (0.0, 1.5), 20),
            (f"h_ycc{cut}_aftercuts", f"ycc_mcc{cut}", "y(b#bar{b})", (-2.5, 2.5), (0.0, 1.5), 10),
        ])
    return variables
...
PDF_CONFIGS = [
    {
        ...
        "nuclear": "analysis_HI_ccbar_OO_EPPS21nlo_CT18Anlo_O16.root",
        "baseline": "analysis_HI_ccbar_OO_EPPS21nlo_CT18Anlo_O16_pp_reference.root",
        "color": root.kRed + 1,
        "style": 1,
    },
    {
        ...
        "nuclear": "analysis_HI_ccbar_OO_nCTEQ15HQ_FullNucleous_16_8.root",
        "baseline": "analysis_HI_ccbar_OO_nCTEQ15HQ_FullNucleous_16_8_pp_reference.root",
        "color": root.kBlue + 1,
        "style": 2,
    },
    {
        ...
        "nuclear": "analysis_HI_ccbar_OO_TUJU21_16_8.root",
        "baseline": "analysis_HI_ccbar_OO_TUJU21_16_8_pp_reference.root",
        "color": root.kGreen + 2,
        "style": 3,
    },
]
...
def plot_ratio_overview(config_data, hist_name, plot_key, xlabel, xlim, ylim, rebin, outpath):
    ...
    ax.text(0.20, 0.82, "O-O #rightarrow c#bar{c}, #sqrt{s_{NN}} = 5.36 TeV", size=20, align=13)
...
def main():
    ...
    path = "/media/danbiajujumiguel/T7/HI_analysis/OO_ccbar_analysis/output/"
    outpath = "/media/danbiajujumiguel/T7/HI_analysis/OO_ccbar_analysis/plots"
