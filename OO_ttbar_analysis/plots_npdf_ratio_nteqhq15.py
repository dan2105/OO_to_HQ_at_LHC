...
PDF_RATIO_VARIABLES = [
    ...
    ("h_ttbar_pt", "ttbar_pt", "p_{T}(t#bar{t}) [GeV]", (0, 50), (1e-3, 1), 10, "d#sigma/dp_{T}(t#bar{t}) [nb/GeV]"),
    ...
    ("h_ttbar_pt_aftercuts", "ttbar_pt_ac", "p_{T}(t#bar{t}) [GeV]", (0, 50), (1e-3, 1), 10, "d#sigma/dp_{T}(t#bar{t}) [nb/GeV]"),
]
...
def plot_ratio_with_envelope(file_nuclear, file_baseline, hist_name, plot_key, xlabel, xlim, ylim, rebin, ylabel, outpath):
    ...
    legend.AddEntry(band_nuclear, "OO nuclear (NCTEQHQ15)", "lf")
    legend.AddEntry(band_baseline, "OO baseline (CT18NLO)", "lf")
    ...
    fig.savefig(f"{outpath}/npdf_ncteqhq15_ratio_{plot_key}.pdf")
...
def main():
    ...
    file_nuclear = root.TFile(path + "analysis_HI_ttbar_OO_nCTEQ15HQ_FullNucleous_16_8.root")
    file_baseline = root.TFile(path + "analysis_HI_ttbar_OO_nCTEQ15HQ_FullNucleous_16_8_pp_reference.root")
