...
def plot_ratio_with_envelope(file_nuclear, file_baseline, hist_name, plot_key, xlabel, xlim, ylim, rebin, ylabel, outpath):
    ...
    fig.savefig(f"{outpath}/npdf_tuju21_ratio_{plot_key}.pdf")
...
def main():
    ...
    file_nuclear = root.TFile(path + "analysis_HI_ttbar_OO_TUJU21_16_8.root")
    file_baseline = root.TFile(path + "analysis_HI_ttbar_OO_TUJU21_16_8_pp_reference.root")
